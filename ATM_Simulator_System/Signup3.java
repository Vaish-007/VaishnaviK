...
public class Signup3 extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        long first7 = (ran.nextLong() % 90000000L) + 5040936000000000L;   // card number is 16 digits.
        long first8 = Math.abs(first7);

        long first3 = (ran.nextLong() % 9000L) + 1000L;             // pin is 4 digits
        ...
        try{
            ...
            if(ae.getSource()==b1){
                ...
                if(b.equals("")){
                    ...
                    new Deposit().setVisible(true); // deposit amount to start bank account.
                    setVisible(false);
                }
