...
public class Signup extends JFrame implements ActionListener{
    ...
    // Random is a class of util package.
    Random ran = new Random();                      // generates a random form number everytime.
    long first4 = (ran.nextLong() % 9000L) + 1000L;  // generates a four digit integer.
    long first = Math.abs(first4);             // integer can be positive or negative,use abs to make it positive.
    ...
    Signup(){
        ...
        r1.setBackground(Color.WHITE);   // by default has different color.
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String ac = (String)c1.getSelectedItem();     // getSelectedItem() returns an object, hence type cast to String.
        ...
        try{
            ...
            if(t6.getText().equals("")){   // if all the fields are not filled.
                ...
                // executeUpdate(q1) is used when we want to manipulate data in database(insert,update,delete)
